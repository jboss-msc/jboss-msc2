First off, thank you for considering contributing to JBoss MSC 2 project. It's people like you that make JBoss MSC 2 such a great library. JBoss MSC 2 is an open source project and contributions from our community are more than welcome! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into JBoss MSC 2 itself.
...
All recent development happens in the branch `main`. There are additional [branches](https://github.com/jboss-msc/jboss-msc2/branches) mainly used for maintenance.
...
Fork https://github.com/jboss-msc/jboss-msc2 into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/jboss-msc2.git
cd jboss-msc2
```
...
```bash
git remote add upstream git://github.com/jboss-msc/jboss-msc2.git
```

# Development Process

This is the typical process you would follow to submit any changes to JBoss MSC 2.
 ...
 * JBoss MSC 2 Issue Tracker - https://issues.redhat.com/projects/MSC
...
JBoss MSC 2 uses JIRA to manage issues. All issues can be found [here](https://issues.redhat.com/projects/MSC/issues).

To create a new issue, comment on an existing issue, or assign an issue to yourself, you'll need to first [create a JIRA account](https://issues.redhat.com/).

## Good First Issues

Want to contribute to JBoss MSC 2 but aren't quite sure where to start? Check out our issues with the `good-first-issue` label. These are a triaged set of issues that are great for getting started on our project. These can be found [here](https://issues.redhat.com/browse/MSC-262?jql=project%20%3D%20MSC%20AND%20labels%20%3D%20good-first-issue).
